  ...
  initializing: {
    ...
    writing: function () {
      ...
      if (this.dockerType == "dockerpush") {
        ...
        this.template('docker/_app.yml', 'docker/app-local.yml', this, {});
      }
      done();
    },
    ...
    install: function () {
      if (this.dockerType == 'dockerpush') {
        ...
        if (this.buildTool == 'maven') {
          dockerCommand = 'mvn package -Pprod -DskipTests=true docker:build';
      ...
      switch (this.dockerType) {
        ...
        case 'dockerpush': {
          ...
          console.log('- docker-compose -f docker/app-local.yml up\n');
          break;
        }
      }
    }
