...
# Table of contents
  ...
  * [Prerequisites](#prerequisites" aria-hidden="true"><span aria-hidden="true)
  * [Installation](#installation" aria-hidden="true"><span aria-hidden="true)
  * [Usage](#usage" aria-hidden="true"><span aria-hidden="true)
    * [1 - Generate docker-compose services](#1---generate-docker-compose-services" aria-hidden="true"><span aria-hidden="true)
      * [1.1 - Description](#11---description" aria-hidden="true"><span aria-hidden="true)
      * [1.2 - Working with databases](#12---working-with-databases" aria-hidden="true"><span aria-hidden="true)
        * [1.2.1 - Starting MySQL, PostgreSQL or MongoDB](#121---starting-mysql-postgresql-or-mongodb" aria-hidden="true"><span aria-hidden="true)
        * [1.2.2 - Starting Cassandra the first time](#122---starting-cassandra-the-first-time" aria-hidden="true"><span aria-hidden="true)
        * [1.2.3 - Starting Cassandra the next times](#123---starting-cassandra-the-next-times" aria-hidden="true"><span aria-hidden="true)
      * [1.3 - Working with Sonar](#13---working-with-sonar" aria-hidden="true"><span aria-hidden="true)
      * [1.4 - Common commands](#14---common-commands" aria-hidden="true"><span aria-hidden="true)
        * [1.4.1 - List the containers](#141---list-the-containers" aria-hidden="true"><span aria-hidden="true)
        * [1.4.2 - Stop the containers](#142---stop-the-containers" aria-hidden="true"><span aria-hidden="true)
        * [1.4.3 - Delete a container](#143---delete-a-container" aria-hidden="true"><span aria-hidden="true)
    * [2 - Automated build at the <a href="https://hub.docker.com">Docker Hub</a> ](#2---automated-build-at-the-docker-hub" aria-hidden="true"><span aria-hidden="true)
      * [2.1 - Description](#21---description" aria-hidden="true"><span aria-hidden="true)
      * [2.2 - Generate the files](#22---generate-the-files" aria-hidden="true"><span aria-hidden="true)
      * [2.3 - Set your Docker Hub project](#23---set-your-docker-hub-project" aria-hidden="true"><span aria-hidden="true)
    * [3 - Containerize your application and push image to <a href="https://hub.docker.com/">Docker Hub</a> ](#3---containerize-your-application-and-push-image-to-docker-hub" aria-hidden="true"><span aria-hidden="true)
      * [3.1 - Description](#31---description" aria-hidden="true"><span aria-hidden="true)
      * [3.2 - Containerize your application](#32---containerize-your-application" aria-hidden="true"><span aria-hidden="true)
      * [3.3 - Examples](#33---examples" aria-hidden="true"><span aria-hidden="true)
        * [3.3.1 - Generate a JHipster application](#331---generate-a-jhipster-application" aria-hidden="true"><span aria-hidden="true)
        * [3.3.2 - Containerize your JHipster application](#332---containerize-your-jhipster-application" aria-hidden="true"><span aria-hidden="true)
        * [3.3.3 - Use src/main/docker/app.yml](#333---use-srcmaindockerappyml" aria-hidden="true"><span aria-hidden="true)
        * [3.3.4 - Add spring properties](#334---add-spring-properties" aria-hidden="true"><span aria-hidden="true)
        * [3.3.5 - Start in dev profile](#335---start-in-dev-profile" aria-hidden="true"><span aria-hidden="true)
  * [License](#license" aria-hidden="true"><span aria-hidden="true)
